...
const ManageUserPage = () => {
  ...
  const userData = allUserData.filter((user: any) => user.role === "user");
  const loading = !data;
          ...
          <table className="min-w-full bg-default-300 shadow-lg rounded-lg">
            <thead>
              <tr className="bg-blue-100 text-left text-gray-700">
                ...
                <th className="py-3 px-5" colSpan={2}>
                  Action
                </th>
              </tr>
            </thead>
                  ...
                  <tr key={user._id} className="border-b hover:bg-default-400">
                    ...
                    <td className="py-3 px-5">
                      {user?.isBlock ? (
                        <button
                          ...
                          onClick={() =>
                            onActionClick({ userId: user._id, action: "block" })
                          }
                        >
                          Unblock
                        </button>
                    ...
                    <td className="py-3 px-5">
                      <button
                        ...
                        onClick={() =>
                          onActionClick({ userId: user._id, action: "delete" })
                        }
                      >
                        Delete
                      </button>
